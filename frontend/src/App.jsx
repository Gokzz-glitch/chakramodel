...
function App() {
  ...
  return <div className="shell">
    <aside className="sidebar">
      <div className="brand"><div className="brand-mark"><span /></div><div><strong>PrimeOxy</strong><small>Air intelligence</small></div></div>
      <div className="workspace"><span className="workspace-dot" /> PrimeOxy AQI Dataset <span className="chevron">⌄</span></div>
